...
bool CreateNativeHardlink(LPCWSTR linkname, LPCWSTR targetname)
{
	...
	printf("[+] Creating a FILE_LINK_INFORMATION STRUCTURE for the source file \n");
	...
	printf("[+} Opening the target file with FILE_SHARE_READ \n");
	...
	if (hFile)
	{
		...
		printf("[+] Setting the FILE_LINK_INFORMATION to target file using ZwSetInformationFile\n");
